...
int	parse_input(t_obj ***objects, t_scene *scene)
{
	...
	scene->lights[0] = ft_malloc(sizeof(t_light));
	...
	scene->lights[1] = ft_malloc(sizeof(t_light));
...
//	new_sphere(&(*objects)[0].sphere, (*objects)[0].sphere.center, radius);
	(*objects)[0] = ft_calloc(sizeof(t_obj), 1);
	(*objects)[0]->type = TOK_CYLINDER;
	(*objects)[0]->color = 0x00da2b27;
	...
	(*objects)[0]->color = 0x00da2b27;
	(*objects)[1] = ft_calloc(sizeof(t_obj), 1);
	(*objects)[1]->type = TOK_PLANE;
	...
	(*objects)[2] = ft_calloc(sizeof(t_obj), 1);
	(*objects)[2]->type = TOK_PLANE;
